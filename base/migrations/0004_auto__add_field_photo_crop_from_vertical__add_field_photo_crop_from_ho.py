...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.crop_from_vertical'
        db.add_column('base_photo', 'crop_from_vertical', self.gf('django.db.models.fields.SmallIntegerField')(default=1), keep_default=False)

        # Adding field 'Photo.crop_from_horizontal'
        db.add_column('base_photo', 'crop_from_horizontal', self.gf('django.db.models.fields.SmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.crop_from_vertical'
        db.delete_column('base_photo', 'crop_from_vertical')

        # Deleting field 'Photo.crop_from_horizontal'
        db.delete_column('base_photo', 'crop_from_horizontal')
    ...
    models = {
        ...
        'base.photo': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'crop_from_horizontal': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'crop_from_vertical': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
